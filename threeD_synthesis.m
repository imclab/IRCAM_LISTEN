...
load(['IRC_' subject_s filesep raw_mat_directory_s filesep 'IRC_' subject_s '_C_HRIR.mat'],'l_eq_hrir_S','r_eq_hrir_S');

l_hrir_S = l_eq_hrir_S;
r_hrir_S = r_eq_hrir_S;
